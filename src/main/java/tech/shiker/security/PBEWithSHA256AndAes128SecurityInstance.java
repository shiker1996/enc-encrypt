...
public class PBEWithSHA256AndAes128SecurityInstance implements SecurityInstance {
    @Override
    public EncryptResult encrypt(String src, String key, String index, String salt, Integer iterations ) throws Exception {
        ...
        SecretKey secretKey = SecretKeyFactory.getInstance(SecurityMethod.PBE_WITH_SHA256_AND_AES_128.decryptType()).generateSecret(keySpec);
        ...
        Cipher cipher = Cipher.getInstance(SecurityMethod.PBE_WITH_SHA256_AND_AES_128.decryptInformation());
