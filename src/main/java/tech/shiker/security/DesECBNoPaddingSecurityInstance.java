...
public class DesECBNoPaddingSecurityInstance implements SecurityInstance {
    ...
    public EncryptResult encrypt(String src, String key) throws Exception {
        ...
        SecretKeySpec keySpec = new SecretKeySpec(key.getBytes(StandardCharsets.UTF_8), SecurityMethod.DES_ECB_NO_PADDING.decryptType());
